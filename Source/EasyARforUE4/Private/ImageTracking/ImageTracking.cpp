...
#define EASYAR_IMPORT __declspec(dllimport)
#else
#define EASYAR_IMPORT
#endif
#include <thread>
...
void AImageTracker::LoadFromImage(const FString& FilePath)
{
	std::optional<std::shared_ptr<easyar::ImageTarget>> ImageTarget =
		easyar::ImageTarget::createFromImageFile(TCHAR_TO_UTF8(*FilePath), easyar::StorageType::Assets, "", "", "", 1.0f);
...
void AImageTracker::Initialize()
{
	...
	// LoadFromImage("../Resources/idback.jpg");
